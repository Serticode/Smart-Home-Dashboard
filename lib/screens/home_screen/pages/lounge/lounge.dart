...
class _LoungeState extends State<Lounge> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        valueListenable: _loungeDevices.listenable(),
        builder: (context, value, child) => _loungeDevices.isEmpty
            ? Center(child: Text("You haven't added any device to this room."))
            : MasonryGridView.count(
                itemCount: _loungeDevices.length,
                crossAxisCount: 2,
                mainAxisSpacing: 21,
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              ...
                              SwitchListTile.adaptive(
                                  ...
                                  title: Text(_loungeDevices.values
                                              .elementAt(index)
                                              .isDeviceOn ==
                                          true.toString()
                                      ? "On"
                                      : "Off"),
                                  value: _loungeDevices.values
                                              .elementAt(index)
                                              .isDeviceOn ==
                                          "true"
                                      ? true
                                  ...
                                  onChanged: (value) => setState(() {
                                        ...
                                        value
                                            ? AppFunctionalUtils.showAppSnackBar(
                                                ...
                                                message:
                                                    "${_loungeDevices.values.elementAt(index).deviceName} turned ON!")
                                            : AppFunctionalUtils.showAppSnackBar(
                                                theBuildContext: context,
                                                message:
                                                    "${_loungeDevices.values.elementAt(index).deviceName} turned OFF!");
                                      })),
                            ]),
                          ),
                                  ...
                                  Column(children: [
                                    ...
                                    InkWell(
                                      onTap: () => AppProviders.removeDevice(
                                          theDevice: _loungeDevices.values
                                              .elementAt(index)),
